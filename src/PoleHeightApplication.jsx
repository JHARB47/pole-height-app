...
const LazyProposedLineCalculator = React.lazy(
  () => import("./components/LazyProposedLineCalculator"),
);
...
const PoleHeightApplication = () => {
  ...
  const existingLines = useAppStore(
    (s) => s.importedExistingLines || s.existingLines || [],
  );
  const job = {
