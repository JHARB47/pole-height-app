...
export const EXPORT_PRESETS = {
  ...
  PERMIT: {
    ...
    columns: [
      'poleId', 'poleHeight', 'poleClass', 'latitude', 'longitude',
      'voltage', 'powerHeight', 'attachmentHeight',
      'groundClearance', 'powerToCommClearance', 'roadClearance',
      'complianceStatus'
    ]
  },
  FIELD: {
    ...
    columns: [
      'poleId', 'poleHeight', 'poleClass', 'latitude', 'longitude',
      'attachmentHeight', 'spanDistance', 'timestamp', 'inspector', 'notes'
    ]
  }
};
