...
export function validateLineStringGeometry(lineString) {
  ...
  if (!Array.isArray(lineString.coordinates) || lineString.coordinates.length < 2) {
    return {
      valid: false,
 ...
 */
export function validateDistanceBetweenPoints(coord1, coord2, maxDistanceMeters = 10000) {
