...
export declare function normalizeIncludedAngleDeg(
  bearingA: number,
  bearingB: number,
): number;
export declare function pullFromAngleDeg(
  thetaDeg: number,
  baseSpanFt?: number,
): number;
export declare function angleDegFromPull(
  pullFt: number,
  baseSpanFt?: number,
): number;
export declare function computePullAutofill(args: {
  incomingBearingDeg: number;
  outgoingBearingDeg: number;
  baseSpanFt?: number;
}): { thetaDeg: number; pullFt: number };
...
export function getPoleBurialData(
  height: any,
  poleClass?: string,
): {
  buried: number;
...
export function calculateSag(
  ...
  tensionLbs: any,
  windSpeedMph?: number,
  cableDiameterIn?: number,
  iceThicknessIn?: number,
): number;
export function calculateDownGuy(
  poleAboveGroundFt: any,
  attachmentHeightFt: any,
  cableData: any,
  spanLengthFt: any,
  windSpeedMph?: number,
  pullDirectionDeg?: number,
): {
  required: boolean;
  tension: number;
  angle: number;
...
export function recommendPoleReplacement(
  poleHeightFt: any,
  requiredAboveGroundFt: any,
): {
  replace: boolean;
