...
describe('GIS Validation', () => {
  ...
  describe('validatePointGeometry', () => {
    ...
    it('rejects invalid Point geometry', () => {
      ...
      expect(validatePointGeometry({ type: 'Point', coordinates: [1] }).valid).toBe(false);
      expect(validatePointGeometry({ type: 'Point', coordinates: [181, 45] }).valid).toBe(false);
    });
  });
  ...
  describe('validateDistanceBetweenPoints', () => {
    it('validates points within max distance', () => {
      ...
      const coord2 = [-122.6800, 45.5250]; // Very close
  ...
  describe('validatePoleBatch', () => {
    it('validates batch of poles', () => {
      const poles = [
        ...
        { id: 'pole2', latitude: 45.5240, longitude: -122.6770 },
        { id: 'pole3', latitude: 45.5250, longitude: -122.6780 }
      ];
    ...
    it('reports errors in batch', () => {
      const poles = [
        ...
        { id: 'pole2', latitude: 91, longitude: -122.6770 }, // Invalid
        { id: 'pole3', latitude: 45.5250 } // Invalid (missing longitude)
      ];
      const result = validatePoleBatch(poles);
