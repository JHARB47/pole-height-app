...
export async function buildMM109PDF(summary) {
  ...
  draw(`Generated: ${new Date().toLocaleString()}`, 50, 730, false, 10, rgb(0.2, 0.2, 0.2));
  ...
  y -= 6;
  draw('Attachment', 50, y, true); y -= 16;
  ...
  for (const n of notes) { draw(`• ${n}`, 60, y); y -= 14; }
