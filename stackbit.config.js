// Full JS config for Netlify Visual Editor compatibility.
// Mirrors the TS config so environments that only parse JS can still load models and content.
			...
			models: [
				...
				},
				{
					...
					fields: [
						...
						{ name: 'features', label: 'Features', type: 'list', items: { type: 'model', models: ['FeatureItem'] } }
					]
				},
				{
					name: 'CtaSection',
