...
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
console.log('📊 Connection:', DATABASE_URL.includes('pooler') ? 'Pooled' : 'Unpooled (Direct)');
...
function parseMigrationFile(filename) {
  ...
  throw new Error(`Invalid migration filename: ${filename}. Expected format: 001_name.sql or 20250101120000_name.sql`);
}

async function runMigration(migration) {
  const filepath = path.join(__dirname, '../../server/migrations', migration.filename);
